...
import droid.multistate.handler.LeastLoadingStateChangeHandler
import droid.multistate.handler.LeastLoadingStatusView
import droid.multistate.handler.StateChangeHandler
...
class StateLayout @JvmOverloads constructor(
     ...
     * attach集合：当前关联的所有状态
     */
    internal val allStatusView: MutableMap<Int, StatusView> = MultiState.statusSnapshot()
    ...
    var stateChangedHandler: StateChangeHandler
        get() = _stateChangeHandler ?: MultiState.stateChangeHandler ?: StateChangeHandler
        set(value) {
    ...
    fun addCustom(state: StatusView) {
        require(!MultiState.isInnerStatus(state.status)) {
